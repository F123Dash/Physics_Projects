...
constexpr const char* OUTPUT_CSV     = "./data_outputs/2D_data.csv";
constexpr const char* PHASE_VEL_CSV  = "./data_outputs/2D_phase_vel.csv";
constexpr const char* DISPERSION_CSV = "./data_outputs/2D_dispersion.csv";
constexpr const char* SWR_CSV        = "./data_outputs/2D_swr_scan.csv";   // steady-state |Ez| envelope along x
